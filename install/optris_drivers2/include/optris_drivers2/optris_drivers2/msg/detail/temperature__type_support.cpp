...
{
  new (message_memory) optris_drivers2::msg::Temperature(_init);
}

void Temperature_fini_function(void * message_memory)
{
  auto typed_message = static_cast<optris_drivers2::msg::Temperature *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Temperature_message_member_array[4] = {
  {
    ...
    offsetof(optris_drivers2::msg::Temperature, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(optris_drivers2::msg::Temperature, temperature_flag),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(optris_drivers2::msg::Temperature, temperature_box),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(optris_drivers2::msg::Temperature, temperature_chip),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Temperature_message_members = {
  ...
  4,  // number of fields
  sizeof(optris_drivers2::msg::Temperature),
...
{
  return &::optris_drivers2::msg::rosidl_typesupport_introspection_cpp::Temperature_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, optris_drivers2, msg, Temperature)() {
  return &::optris_drivers2::msg::rosidl_typesupport_introspection_cpp::Temperature_message_type_support_handle;
}
