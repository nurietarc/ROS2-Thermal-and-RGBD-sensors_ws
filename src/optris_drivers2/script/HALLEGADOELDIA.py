...
def main(args=None):
    ...
    image_rescaler = ImageRescaler(homography_file=args.homography_file, name_class=args.name_class, number_class=args.number_class)  # Pasar el valor correcto
