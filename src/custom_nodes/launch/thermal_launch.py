...
def generate_launch_description():
    ...
    modify_xml_file_path = os.path.expanduser('~/sensors_ws/src/custom_nodes/script/modify_xml.py')    # Ruta al archivo de modificacion del XML
    ...
    rviz_config_file = os.path.expanduser('~/sensors_ws/src/custom_nodes/launch/rviz2_config_thermal.rviz') # path to configuration file
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
