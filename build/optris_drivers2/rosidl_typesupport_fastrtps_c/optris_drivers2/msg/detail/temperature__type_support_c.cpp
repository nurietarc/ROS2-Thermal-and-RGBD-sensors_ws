...
#include "optris_drivers2/msg/detail/temperature__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_optris_drivers2
...
using _Temperature__ros_msg_type = optris_drivers2__msg__Temperature;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: temperature_flag
  {
    cdr << ros_message->temperature_flag;
  }

  // Field name: temperature_box
  {
    cdr << ros_message->temperature_box;
  }

  // Field name: temperature_chip
  {
    cdr << ros_message->temperature_chip;
  }
...
size_t get_serialized_size_optris_drivers2__msg__Temperature(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Temperature__ros_msg_type * ros_message = static_cast<const _Temperature__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name temperature_flag
  {
    size_t item_size = sizeof(ros_message->temperature_flag);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name temperature_box
  {
    size_t item_size = sizeof(ros_message->temperature_box);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name temperature_chip
  {
    size_t item_size = sizeof(ros_message->temperature_chip);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Temperature__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_optris_drivers2__msg__Temperature(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_optris_drivers2
size_t max_serialized_size_optris_drivers2__msg__Temperature(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = optris_drivers2__msg__Temperature;
    is_plain =
      (
      offsetof(DataType, temperature_chip) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Temperature__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_optris_drivers2__msg__Temperature(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, optris_drivers2, msg, Temperature)() {
