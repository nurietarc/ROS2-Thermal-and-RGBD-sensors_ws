...
#include "optris_drivers2/msg/detail/temperature__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = optris_drivers2::msg::Temperature;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const optris_drivers2::msg::Temperature *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<optris_drivers2::msg::Temperature *>(
    untyped_ros_message);
...
{
  return &optris_drivers2::msg::typesupport_fastrtps_cpp::_Temperature__handle;
}
