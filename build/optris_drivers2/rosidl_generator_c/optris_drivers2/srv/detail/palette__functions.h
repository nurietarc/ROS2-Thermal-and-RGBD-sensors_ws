...
#ifndef OPTRIS_DRIVERS2__SRV__DETAIL__PALETTE__FUNCTIONS_H_
#define OPTRIS_DRIVERS2__SRV__DETAIL__PALETTE__FUNCTIONS_H_
...
/// Initialize srv/Palette message.
/**
...
/// Create srv/Palette message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * optris_drivers2__srv__Palette_Request__init().
...
/// Destroy srv/Palette message.
/**
 * It calls
 * optris_drivers2__srv__Palette_Request__fini()
...
/// Check for srv/Palette message equality.
/**
...
/// Initialize array of srv/Palette messages.
/**
...
/// Finalize array of srv/Palette messages.
/**
 * It calls
 * optris_drivers2__srv__Palette_Request__fini()
...
/// Create array of srv/Palette messages.
/**
 * It allocates the memory for the array and calls
 * optris_drivers2__srv__Palette_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Palette messages.
/**
 * It calls
 * optris_drivers2__srv__Palette_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Palette message array equality.
/**
...
/// Copy an array of srv/Palette messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * optris_drivers2__srv__Palette_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_optris_drivers2
...
/**
 * It calls
 * optris_drivers2__srv__Palette_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_optris_drivers2
...
/**
 * It allocates the memory for the array and calls
 * optris_drivers2__srv__Palette_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_optris_drivers2
...
/**
 * It calls
 * optris_drivers2__srv__Palette_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // OPTRIS_DRIVERS2__SRV__DETAIL__PALETTE__FUNCTIONS_H_
