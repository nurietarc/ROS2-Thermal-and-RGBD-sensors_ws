...
static const _Palette_Request_type_support_symbol_names_t _Palette_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, optris_drivers2, srv, Palette_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, optris_drivers2, srv, Palette_Request)),
  }
};
...
{
  return &::optris_drivers2::srv::rosidl_typesupport_cpp::Palette_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, optris_drivers2, srv, Palette_Request)() {
  return get_message_type_support_handle<optris_drivers2::srv::Palette_Request>();
}
...
static const _Palette_Response_type_support_symbol_names_t _Palette_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, optris_drivers2, srv, Palette_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, optris_drivers2, srv, Palette_Response)),
  }
};
...
{
  return &::optris_drivers2::srv::rosidl_typesupport_cpp::Palette_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, optris_drivers2, srv, Palette_Response)() {
  return get_message_type_support_handle<optris_drivers2::srv::Palette_Response>();
}
...
static const _Palette_type_support_symbol_names_t _Palette_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, optris_drivers2, srv, Palette)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, optris_drivers2, srv, Palette)),
  }
};
...
{
  return &::optris_drivers2::srv::rosidl_typesupport_cpp::Palette_service_type_support_handle;
}
