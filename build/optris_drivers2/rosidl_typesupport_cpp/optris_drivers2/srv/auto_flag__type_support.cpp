...
static const _AutoFlag_Request_type_support_symbol_names_t _AutoFlag_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, optris_drivers2, srv, AutoFlag_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, optris_drivers2, srv, AutoFlag_Request)),
  }
};
...
{
  return &::optris_drivers2::srv::rosidl_typesupport_cpp::AutoFlag_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, optris_drivers2, srv, AutoFlag_Request)() {
  return get_message_type_support_handle<optris_drivers2::srv::AutoFlag_Request>();
}
...
static const _AutoFlag_Response_type_support_symbol_names_t _AutoFlag_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, optris_drivers2, srv, AutoFlag_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, optris_drivers2, srv, AutoFlag_Response)),
  }
};
...
{
  return &::optris_drivers2::srv::rosidl_typesupport_cpp::AutoFlag_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, optris_drivers2, srv, AutoFlag_Response)() {
  return get_message_type_support_handle<optris_drivers2::srv::AutoFlag_Response>();
}
...
static const _AutoFlag_type_support_symbol_names_t _AutoFlag_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, optris_drivers2, srv, AutoFlag)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, optris_drivers2, srv, AutoFlag)),
  }
};
...
{
  return &::optris_drivers2::srv::rosidl_typesupport_cpp::AutoFlag_service_type_support_handle;
}
