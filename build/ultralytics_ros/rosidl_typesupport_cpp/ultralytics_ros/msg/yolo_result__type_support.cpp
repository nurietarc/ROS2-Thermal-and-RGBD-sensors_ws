...
static const _YoloResult_type_support_symbol_names_t _YoloResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ultralytics_ros, msg, YoloResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ultralytics_ros, msg, YoloResult)),
  }
};
...
{
  return &::ultralytics_ros::msg::rosidl_typesupport_cpp::YoloResult_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ultralytics_ros, msg, YoloResult)() {
  return get_message_type_support_handle<ultralytics_ros::msg::YoloResult>();
}
